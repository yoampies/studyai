...
  };
  ...
  // Condición para manejar el caso cuando no hay preguntas
  if (!exam_questions || exam_questions.length === 0) {
    return (
      <div className="text-center text-[#131118] text-lg font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">
