...
// It's a good practice to create reusable components for repeated SVG icons
const FileIcon = () => (
...
function History() {
  ...
  const getButtonClasses = (filterName) => {
    const baseClasses = "flex h-8 shrink-0 items-center justify-center gap-x-2 rounded-lg pl-4 pr-4 text-sm font-medium leading-normal";
        ...
        <div className="px-40 flex flex-1 justify-center py-5">
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
            ...
            <div className="flex gap-3 p-3 flex-wrap pr-4">
              ...
              <div className={getButtonClasses('Summaries')} onClick={() => handleFilterClick('Summaries')}>
                <p className="text-sm font-medium leading-normal">Summaries</p>
              </div>
              <div className={getButtonClasses('Quizzes')} onClick={() => handleFilterClick('Quizzes')}>
            ...
            {filteredDocuments.map((document, index) => (
              <div key={index} className="flex gap-4 bg-white px-4 py-3 justify-between">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex flex-1 flex-col justify-center">
                    ...
                    <p className="text-[#6e6388] text-sm font-normal leading-normal">Tools: {document.tools}</p>
