...
            {/* Wrap each Files component in a Link */}
            <Link to="/upload" state={{ file: "Chapter One Notes" }}>
                <Files title="Chapter One Notes"/>
            </Link>
            <Link to="/upload" state={{ file: "Lecture Slides" }}>
                <Files title="Lecture Slides"/>
            </Link>
            <Link to="/upload" state={{ file: "Textbook Excerpts" }}>
